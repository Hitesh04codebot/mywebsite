      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8">
            <motion.a
              href="#home"
              className="text-text-dark hover:text-primary relative"
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a href="#home" className="block px-3 py-2 text-text-dark hover:text-primary">Home</a>
              <a href="#pgs" className="block px-3 py-2 text-text-dark hover:text-primary">More PGs</a>
              <a href="#contact" className="block px-3 py-2 text-text-dark hover:text-primary">Contact Us</a>
              {user ? (
                <>
